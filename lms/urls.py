...
urlpatterns = [
          ...
          path('lms/course-list', views.CourseListView.as_view(), name  = 'course_list' ),
          path('lms/course_detail/<slug>', views.CourseDetailView.as_view(), name  = 'course_detail' ),
          path('lms/courses/<course_slug>/<module_slug>/', ModuleDetailView.as_view(), name='module_detail'),
